...
evdi-lindroid-y := evdi_connector.o evdi_encoder.o evdi_event.o evdi_ioctl.o evdi_lindroid_drv.o evdi_modeset.o evdi_sysfs.o
...
ccflags-y := -isystem include/uapi/drm $(CFLAGS) $(EL8FLAG) $(EL9FLAG) $(RPIFLAG)
evdi-y := evdi_connector.o evdi_encoder.o evdi_event.o evdi_ioctl.o evdi_lindroid_drv.o evdi_modeset.o evdi_sysfs.o
